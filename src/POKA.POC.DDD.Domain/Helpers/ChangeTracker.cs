...
namespace POKA.POC.DDD.Domain.Helpers
{
    public abstract class ChangeTracker : INotifyPropertyChanged, IRevertibleChangeTracking
    {
        ...
        /// <summary>
        /// Provides data for the <see cref=" System.ComponentModel.PropertyChangedEventArgs"/> event
        /// </summary>
        public class PropertyChangedTrackedEventArgs : System.ComponentModel.PropertyChangedEventArgs
        {
        ...
        /// </summary>
        public class ChangeTrackerIgnoreAttribute : System.Attribute { }
